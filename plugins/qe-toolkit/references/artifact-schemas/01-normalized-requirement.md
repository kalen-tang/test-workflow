...
normalizer: "req-parser"  # 必须，规范化工具名称

metadata:                             # 文档元数据
  module: "用户管理模块"               # 必须，模块名称
  doc_version: "V1.2"                 # 文档版本，如无则填"未知"
  processed_by: "req-parser v1.0"  # 可选
...
| `normalizer` | string | 规范化工具名称，如 `req-parser` |
