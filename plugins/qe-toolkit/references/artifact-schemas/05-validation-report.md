...
**创建时间**: 2026-03-18
**适用阶段**: 第二阶段（需求检查）
**输出工具**: doc-reviewer Skill
**下游消费者**: case-designer、项目决策
...
appendix:
  ...
  # 验证工具信息
  validator_info:
    tool_name: "doc-reviewer"
    version: "1.0.0"
    documentation: "skills/doc-reviewer/SKILL.md"
```
