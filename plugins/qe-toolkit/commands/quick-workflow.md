...
/qe-quick https://km.yourcompany.com/doc/12345
...
```bash
# 开发团队提供 KM 文档后立即生成测试
/qe-quick ./docs/new-feature-plan.md
```
...
```bash
# 接口修改后快速更新测试用例
/qe-quick ./docs/api-update-plan.md
```
...
```bash
# 从线上 KM 系统直接生成测试
/qe-quick https://km.company.com/doc/feature-123
```
...
```bash
/qe-config output_dir ./custom-output
/qe-quick ./docs/plan.md
```
