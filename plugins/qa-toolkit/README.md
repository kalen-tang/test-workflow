...
/qa-manual ./docs/requirement.md    # 手工案例
/qa-quick ./docs/plan.md            # API 自动化
```
...
### 3. manual-case-generator（手工案例生成器）
...
### 5. requirement-normalizer（需求文档规范化器）✅
...
```bash
/design-normalizer ./docs/design.docx
```
...
| Skill | 输入格式 | 输出格式 |
|-------|---------|---------|
| requirement-normalizer | 原始需求文档 | 01-normalized-requirement |
| design-normalizer | 原始设计文档 | 02-normalized-design |
| requirement-validator | 01 + 02 + 04 | 05-validation-report |
| manual-case-generator | 01 + 02 + 03 + 04 | 06-manual-test-cases |
| api-case-generator | 06 + 01~04 | 07-api-test-cases |
...
| 命令 | 文档 | 说明 |
|------|------|------|
| `/qa-quick` ⭐ | [quick-workflow.md](./commands/quick-workflow.md) | 快速模式工作流 |
| `/qa-manual` | [manual-case.md](./commands/manual-case.md) | 手工测试案例生成 |
| `/qa-full` 🚧 | [full-workflow.md](./commands/full-workflow.md) | 完整模式工作流 |
| `/qa-status` | [status.md](./commands/status.md) | 查看工具状态 |
| `/qa-config` | [config.md](./commands/config.md) | 配置工具参数 |
| `/qa-help` | [help.md](./commands/help.md) | 显示帮助信息 |

### Skills 文档

| Skill | 文档 | 参考文档 |
|-------|------|---------|
| shift-left-analyzer | [SKILL.md](./skills/shift-left-analyzer/SKILL.md) | [references/](./skills/shift-left-analyzer/references/) (4个), [examples/](./skills/shift-left-analyzer/examples/) |
| requirement-validator | [SKILL.md](./skills/requirement-validator/SKILL.md) | - |
| manual-case-generator | [SKILL.md](./skills/manual-case-generator/SKILL.md) | [references/](./skills/manual-case-generator/references/) (4个), [examples/](./skills/manual-case-generator/examples/) (5个) |
| api-case-generator | [SKILL.md](./skills/api-case-generator/SKILL.md) | [references/](./skills/api-case-generator/references/) (6个), [examples/](./skills/api-case-generator/examples/) |
| requirement-normalizer | [SKILL.md](./skills/requirement-normalizer/SKILL.md) | [references/](./skills/requirement-normalizer/references/), [examples/](./skills/requirement-normalizer/examples/) |
| design-normalizer | [SKILL.md](./skills/design-normalizer/SKILL.md) | [references/](./skills/design-normalizer/references/) |
