...
```bash
# 多个需求文档整合为一个测试方案
/qa-manual ./docs/req1.md ./docs/req2.md ./docs/req3.docx
```
...
```bash
# 生成可视化测试用例用于评审
/qa-manual ./docs/requirement.docx --output ./review
```
...
如需生成自动化测试代码，可将此输出作为参考，结合 `/api-case-generator` 命令。
...
- `/qa-quick` - 快速模式工作流（KM 文档 → 接口测试）
- `/qa-full` - 完整模式工作流（需求 → 手工用例 → 自动化用例）
- `/requirement-validator` - 需求文档验证
- `/api-case-generator` - 生成自动化测试代码
- `/qa-status` - 查看工具状态
- `/qa-help` - 查看帮助信息
...
- [SKILL.md](../skills/qa-manual/SKILL.md) - 完整的技能文档

### 参考文档

- [PlantUML 流程图生成规则](../skills/qa-manual/references/01-flowchart-generation.md)
- [测试功能点 MindMap 生成规则](../skills/qa-manual/references/02-test-points-mindmap.md)
- [详细测试案例 MindMap 生成规则](../skills/qa-manual/references/03-test-cases-mindmap.md)
- [测试案例命名规范详解](../skills/qa-manual/references/04-naming-conventions.md)

### 示例文件

- [示例需求文档](../skills/qa-manual/examples/sample-requirement.md)
- [完整输出示例](../skills/qa-manual/examples/sample-output.md)
- [流程图示例](../skills/qa-manual/examples/sample-flowchart.puml)
- [测试功能点示例](../skills/qa-manual/examples/sample-test-points.puml)
- [测试案例示例](../skills/qa-manual/examples/sample-test-cases.puml)
...
**输入**：
```bash
/qa-manual ./docs/search-feature.md
```
...
🎯 下一步操作:
   ...
   4. 生成自动化测试（可选）:
      /api-case-generator ./result/search_feature_测试左移分析报告.md
```
...
**输入**：
```bash
/qa-manual ./docs/ui-requirement.md ./docs/api-requirement.md ./docs/business-rules.docx
```
